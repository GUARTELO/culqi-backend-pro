    ...
    async getOrder(orderId) {
        try {
            const response =
                ...
                // ============================================================
// 🔎 INICIO CULQI-GETORDER-SPY - DIAGNÓSTICO PASIVO
// OBSERVA ÚNICAMENTE LA RESPUESTA REAL DEL GET
// NO MODIFICA response NI response.data
// PARA ELIMINAR: BORRAR DESDE ESTE MARCADOR HASTA
// EL MARCADOR "FIN CULQI-GETORDER-SPY"
// ============================================================
try {
    ...
    logger.info(
        '🕵️ [CULQI-GETORDER-SPY] ===== RESPUESTA REAL GETORDER =====',
        {
            requestedOrderId: orderId,

            responseOrderId: data.id || null,
            orderIdCoincide:
                data.id === orderId,
            ...
            expirationDateIso:
                toIso(data.expiration_date),

            availableOn:
                data.available_on ?? null,
            ...
            httpMethod:
                response?.config?.method?.toUpperCase() || null,

            httpUrl:
                response?.config?.url || null,

            httpBaseURL:
                response?.config?.baseURL || null,
    ...
    logger.info(
        '🕵️ [CULQI-GETORDER-SPY] ===== FIN GETORDER =====',
        {
            requestedOrderId: orderId,
            responseOrderId: data.id || null,
    ...
    logger.warn(
        '⚠️ [CULQI-GETORDER-SPY] Error interno del diagnóstico (GETORDER continúa normalmente)',
        {
            requestedOrderId: orderId,
            error: spyError.message
        }
    );
}

// ============================================================
// 🔎 FIN CULQI-GETORDER-SPY
// TODO ESTE BLOQUE ES TEMPORAL Y DEBE ELIMINARSE
// DESDE "INICIO CULQI-GETORDER-SPY" HASTA AQUÍ
// ============================================================
